...
class KalshiBase:
    ...
    def make_request(self, method: str, path: str, limit=100, cursor=None, params=None) -> requests.Response:
    ...
    def get_paginated_results(self, method: str, path: str, params=None) -> list:
        ...
        while True:
            response = self.make_request(method, path, cursor=cursor, params=params)
            data = response.json()
