...
- PR title: `<prefix>/<short-kebab-summary>`
...
| `refactor` | `refactor` | Refactoring without new behavior | `refactor/cleanup-scrapers` | `refactor/cleanup-scrapers` |
...
| `revert` | `revert` | Reverting a previous change | `revert/feat-broken-feature` | `revert/feat-broken-feature` |
| `release` | `release` | Release preparation | `release/v3-0-0` | `release/v3-0-0` |
